...
public:
	...
	inline T &operator()(TCoord x, TCoord y) {return data[x + y*size[0]];}
	inline T &operator()(TCoord x, TCoord y, TCoord z) {return data[x + y*size[0] + z*size[0]*size[1]];}

	///Coordinates read-only version
	inline T operator()(TCoord x, TCoord y) const {return data[x + y*size[0]];}
	inline T operator()(TCoord x, TCoord y, TCoord z) const {return data[x + y*size[0] + z*size[0]*size[1]];}
